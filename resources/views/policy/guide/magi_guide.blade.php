    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="border rounded-3 bg-light p-3 mb-5 mt-5">
                ...
                <div class="mb-5"><small>magiはフリマアプリ「楽天ラクマ」とのサービス連携を行い、magiに出品した商品を「楽天ラクマ」にも同時掲載することが可能になりました。</small></div>
                <h6 class="mb-4">楽天ラクマとのサービス連携に関する概要</h6>
                <div class="mb-2"><small>・magiに出品した商品が「楽天ラクマ」にも同時掲載されます。</small></div>
                <div class="mb-2"><small>・magiに出品した商品が「楽天ラクマ」で売れた場合も、出品者はmagiで売れた時と同様に発送を行い、magiで売上金を受け取ることが可能です。</small></div>
                ...
                <div class="mb-2"><small>・楽天ラクマの購入者に商品が購入された場合は、購入者が1つのアカウントに集約された「楽天ラクマ magi公式店」というアカウントにて取引が開始されます。</small></div>
                <div class="mb-2"><small>・「楽天ラクマ magi公式店」では、楽天ラクマでの個人アカウントの評価を確認することはできません。</small></div>
                <div class="mb-2"><small>・取引画面に表示される購入者の住所は「楽天ラクマ」に登録している購入者の住所となります。表示された住所へ商品発送をお願いします。</small></div>
                <div class="mb-2"><small>・magiかんたん配送を選択されている商品は、通常どおり匿名配送がご利用いただけます。</small></div>
                <div class="mb-5"><small>・楽天ラクマ経由で商品が購入された取引においては、取引コメント、キャンセル申請、評価依頼機能がご利用いただけません。お問い合わせフォームよりmagi運営事務局へお問い合わせください。</small></div>
                <h6 class="mb-4">その他の注意事項</h6>
                <div class="mb-2"><small>・出品連携は自動的に行われます。出品連携を行うための特別な手続きや追加の手数料は発生しません。</small></div>
                <div class="mb-2"><small>・出品の連携を希望されない場合は、連携解除が可能となります。お問い合わせフォームよりmagi運営事務局へお問い合わせください。</small></div>
                <div class="mb-2"><small>・「楽天ラクマ」のガイドラインに準拠しない商品については連携対象外となります。</small></div>
                <div class="mb-2"><small>・連携条件を満たす場合であっても、magi運営事務局の判断により出品連携されない場合がございます。</small></div>
                <div class="mb-2"><small>・「楽天ラクマ」に連携された商品は、「楽天ラクマ」上で「magi個人ユーザー直販ショップ」というアカウントにて出品されます。</small></div>
                <div class="mb-2"><small>・magiの出品者のアカウント名や個人情報は「楽天ラクマ」の購入者には表示されません</small></div>
                <div class="mb-5"><small>・ご自身の個人アカウントで出品した商品が、「楽天ラクマmagi公式店」に購入された場合も、取引完了時にご自身の個人アカウントに評価が反映されます。しかしながら、評価コメントは連携されませんのでご了承ください。</small></div>
