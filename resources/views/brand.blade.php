...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb p-3 bg-body-tertiary rounded-3">
      ...
      <li class="breadcrumb-item">
        <a class="link-body-emphasis fw-semibold text-decoration-none" href="javascript:void(0);">@php $name = App\Models\Brand::find($id); echo $name['brand']; @endphp</a>
      </li>
    </ol>
</nav>
<div class="col-lg-12">
    <div class="row">
        ...
        <div class="col-lg-9">
            <div class="row mb-2">
                <div class="col-lg-4">
                    <h5>@php $name = App\Models\Brand::find($id); echo $name['brand']; @endphp 商品一覧</h5>
                </div>
            </div>
            <div class="row" id="order">
                @if ( $brand->count() > 0 )
                    @foreach($brand as $products)
                    <a href="{{ route('product',$products['id']) }}" class="col-lg-3 mb-3">
