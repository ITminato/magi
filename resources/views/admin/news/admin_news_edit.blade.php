                ...
                <div class="border rounded-3 p-2 bg-light mb-4">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @endif
                            <form action="{{url('admin/news').'/'.$notice->id}}" method="post" class="p-5">
                                @method('PUT')
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-4">
                                    ...
                                    <div class="row">
                                        <input type="text" class="form-control" id="product_name" placeholder="最大120文字" name="title" value="{{$notice->title}}" >
                                    </div>
                                    @error('title')
                                ...
                                <div class="row d-flex flex-row flex-wrap mb-4 p-2" id="image_previews">
                                    @if(isset($notice->news_img_1))
                                        <div id="_product_img_1" class="" style="width:33%;max-height:18em;padding:50px auto" ><img src="{{$notice->news_img_1}}" style="width:100%;height:80%" name="img_url" class="img-fluid" /><button type="button" style="width:100%;border-radius:0" onclick="$('#product_img_1').remove();$('#_product_img_1').remove();" class="btn btn-secondary">削除</button></div>
                                        <textarea style="display: none;" id="product_img_1" class="form-control" name="news_img_1" >{{$notice->news_img_1}}</textarea>
                                    @endif
                                    @if(isset($notice->news_img_2))
                                        <div id="_product_img_2" class="" style="width:33%;max-height:18em;padding:50px auto" ><img src="{{$notice->news_img_2}}" style="width:100%;height:80%" name="img_url" class="img-fluid" /><button type="button" style="width:100%;border-radius:0" onclick="$('#product_img_2').remove();$('#_product_img_2').remove();" class="btn btn-secondary">削除</button></div>
                                        <textarea style="display: none;" id="product_img_2" class="form-control" name="news_img_2" >{{$notice->news_img_2}}</textarea>
                                    @endif
                                    @if(isset($notice->news_img_3))
                                        <div id="_product_img_3" class="" style="width:33%;max-height:18em;padding:50px auto" ><img src="{{$notice->news_img_3}}" style="width:100%;height:80%" name="img_url" class="img-fluid" /><button type="button" style="width:100%;border-radius:0" onclick="$('#product_img_3').remove();$('#_product_img_3').remove();" class="btn btn-secondary">削除</button></div>
                                        <textarea style="display: none;" id="product_img_3" class="form-control" name="news_img_1" >{{$notice->news_img_3}}</textarea>
                                    @endif
